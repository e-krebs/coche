...
Built and tested: SPA shell, local store, list UI (multiple lists in a panel that is a bottom sheet
on a phone and a sidebar on a wide screen — create, rename, reorder, delete — unchecked/checked
sections, search, rename, quantity, dnd-kit
