...
export const en = {
  ...
  listsEditing: "Editing lists.",
  listsEditingDone: "Done editing lists.",
  listDeleted: "Deleted the list “{name}”.",
...
export const fr: Record<MessageKey, Message> = {
  ...
  listsEditing: "Modification des listes.",
  listsEditingDone: "Modification des listes terminée.",
