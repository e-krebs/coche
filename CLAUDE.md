...
| `src/client/components/*.tsx` (`ListView`, `ListPicker`, `AccountButton`, `ConfirmDialog`, `LanguageDialog`, `focus.ts`) — roster UI, account/header controls, dialog focus contract | explanation | [docs/explanation/architecture.md](docs/explanation/architecture.md) (Design & UX, components) |
