...
| `src/client/components/*.tsx` (`ListView`, `ListPicker`, `ConfirmDialog`, `LanguageDialog`, `focus.ts`) — roster UI, dialog focus contract | explanation | [docs/explanation/architecture.md](docs/explanation/architecture.md) (Design & UX, components) |
